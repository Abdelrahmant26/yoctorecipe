...
# NOTE: the following library dependencies are unknown, ignoring: vchiq_arm plist bcm_host openmaxil plist-2 brcmGLESv2 brcmEGL vcos
...
#EXTRA_OECMAKE = ""
EXTRA_OECMAKE = "-DCMAKE_C_FLAGS='-I${STAGING_INCDIR}/avahi-compat-libdns_sd' \
                     -DCMAKE_CXX_FLAGS='-I${STAGING_INCDIR}/avahi-compat-libdns_sd'"
